...
import { Database, Shield, ArrowRight, Search } from 'lucide-react';
...
const SystemLogs: React.FC<SystemLogsProps> = ({ logs, onViewDetails }) => {
    return (
            ...
            <AnimatePresence mode="popLayout">
                {logs.length > 0 ? (
                    ...
                    >
                        ...
                        <div>
                            <p className="text-sm font-bold text-foreground">No system logs found</p>
